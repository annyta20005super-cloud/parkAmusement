...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыПАРеализация.ПеренестиПользователейИзПредыдущейВерсии";
	...
	Обработчик.Идентификатор       = "76cc0b92-0d84-4b87-a620-ac66fbfdaf58";
	...
	Обработчик.Процедура           = "Справочники.Клиенты.ПеренестиТелефонВКонтактнуюИнформацию";
	Обработчик.РежимВыполнения	   = "Отложенно";
	Обработчик.Идентификатор       = "0dfc0fc4-613f-4b4c-ac27-be8469302ba2";
	Обработчик.Комментарий         = НСтр("ru = 'Перенос телефона в подсистему Контактная информация'");
