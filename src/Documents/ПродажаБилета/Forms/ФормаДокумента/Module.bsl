...
&НаКлиенте
Процедура ЭтоЛьготныйПриИзменении(Элемент)
	РассчитатьСуммуДокумента();
КонецПроцедуры
#КонецОбласти
...
Процедура РассчитатьСуммуДокумента()
	...
	Элементы.СуммаСкидки.Заголовок = "";
	Если Объект.ЭтоЛьготный Тогда
		Объект.СуммаДокумента = Объект.СуммаДокумента-	Объект.СуммаДокумента*0.1;
		Элементы.СуммаСкидки.Заголовок = Строка(Объект.СуммаДокумента*0.1);
	КонецЕсли;
